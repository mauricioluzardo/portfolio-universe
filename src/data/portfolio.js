...
export const PROJECTS_DONE = [
  ...
  },
  {
    ...
    // Tokens amostrados do site: creme #FDFBF6, navy #22262E,
    // vermelho do CTA #C9323B, dourado do CTA escuro #F0AF1E
    panelStyle: {
      bg:          '#22262E',
      border:      'rgba(240,175,30,0.20)',
      titleFont:   '"Playfair Display", Georgia, serif',
      titleWeight: 400,
      titleColor:  '#FDFBF6',
      accent:      '#F0AF1E',
      accentGrad:  'linear-gradient(135deg,#F0AF1E,#F7CF74)',
      textColor:   '#D2CFC8',
      textMuted:   '#8C8A85',
      divider:     'rgba(240,175,30,0.14)',
    ...
    thumbTheme: {
      ...
      dark: {
        card:         '#22262E',
        cardLow:      '#1A1D24',
        border:       'rgba(240,175,30,0.18)',
        mutedFg:      '#8C8A85',
        activeBg:     '#22262E',
        activeBorder: 'rgba(240,175,30,0.55)',
        activeInset:  '0 0 0 1px rgba(240,175,30,0.35), 0 0 16px rgba(240,175,30,0.18)',
      },
      light: {
        card:         '#22262E',
        cardLow:      '#1A1D24',
